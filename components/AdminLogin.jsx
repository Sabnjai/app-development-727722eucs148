...
const AdminLogin = ({ onClose }) => {
  ...
  const handleSubmit = async(event)=>{
    ...
    // if(email==="rokhithran@gmail.com")
    // {
        setAuth({isAuthenticated:"admin"});
        console.log(auth+"&&&&&");
    // }
  }
    ...
    <div className="main">
        ...
        <div className="login-popup-content" elevation={24}>
            ...
            <label>
                ...
                {!emailError && !passwordError ? <Link to="Landing"><button type='submit'>Login</button></Link> : <button type="submit">Login</button>}
            </form>
        </div>
        </div>
    </div>
